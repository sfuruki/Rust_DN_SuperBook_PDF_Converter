...
mod tests {
    ...
    // TC-PAGENUM-001: 連続�Eージ番号 - 正確なシフト計箁E
    #[test]
    fn test_tc_pagenum_001_sequential_page_numbers() {
        use crate::lib_page_number::types::{DetectedPageNumber, PageNumberRect};
    ...
    // TC-PAGENUM-002: 欠損�Eージ番号 - 補間で補宁E
    #[test]
    fn test_tc_pagenum_002_missing_page_interpolation() {
        use crate::lib_page_number::types::PageNumberRect;
    ...
    // TC-PAGENUM-004: ローマ数孁E- 検�EスキチE�E
    #[test]
    ...
    // TC-PAGENUM-005: 奁E�E位置差 - 個別オフセチE��
    #[test]
