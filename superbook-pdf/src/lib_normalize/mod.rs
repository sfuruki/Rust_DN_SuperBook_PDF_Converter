...
impl ImageNormalizer {
    ...
    pub fn normalize(
        ...
        // Save result as WebP lossless
        let final_img_dyn = image::DynamicImage::ImageRgb8(final_img);
        crate::util::save_webp_lossless(&final_img_dyn, output_path)
            .map_err(|e| NormalizeError::SaveError(e))?;
